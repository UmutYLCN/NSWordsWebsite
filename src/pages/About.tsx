    ...
    <div className="min-h-screen bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-gray-800 rounded-xl shadow-sm p-8 space-y-6">
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">Proje Hakkında</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">Geliştirici</h2>
              <p className="text-gray-400 leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-white">Teknolojiler</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-400">
                <li>React</li>
                <li>TypeScript</li>
                <li>Tailwind CSS</li>
